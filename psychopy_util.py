...
class Presenter(object):
    ...
    def load_all_images(self, img_path, img_extension, img_prefix=None):
        ...
        img_files = {filename: img_path + filename for filename in img_files}
        img_stims = {filename: visual.ImageStim(self.window,
                                                image=img_files[filename],
                                                size=(2.0, self.IMG_WIDTH)) for filename in img_files}
